# source: https://github.com/HackDarmstadt/LoPy-Intro-Sensors/blob/master/Microphone-SPW2430/main.py
...
noise_pin = adc.channel(pin='P17')   # create an analog pin on P16
